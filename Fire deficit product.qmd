...
In this case, I assume the area of the "study area" is the area of the vegetation type, within the ecoregion, within those areas where FRI > 40 years. So this will be significantly smaller than the ecoregion as a whole.
...
#-----------------------------------------------------------------------------#
# The thing I have to do here is calculate the amount of area that each fire 
# burned, that falls within our domain of ecoregion + veg type. I can do this
# with the number of fires raster: it shows how many times each pixel has 
# burned.
#-----------------------------------------------------------------------------#
