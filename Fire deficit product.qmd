...
## CA - Tahoe Sierra SPARK

![](figs/CA - Tahoe Sierra SPARK1.png)
![](figs/CA - Tahoe Sierra SPARK2.png)

![](figs/CA - Tahoe Sierra SPARK3.png)
...
suppressMessages(region_plot <- 
                   ...
                   theme_minimal() +
                   theme(legend.position = "bottom"))
ggsave("figs/state_summary_unzoomed.png", region_plot, width=8.25)
...
suppressMessages(region_plot <- 
                   ...
                   ylim(c(xmin, xmax)) +
                   labs(
                     title = "Zoomed in: mean+sd deficit by state (negative values = deficit)",
                     x = "",
                     y = "Fire deficit (bars show sd)",
                     color = NULL,
                     caption = "Zoomed in for readability, some points omitted"
...
![](figs/state_summary_unzoomed.png)
...
# Recent burns - not set/prescribed
